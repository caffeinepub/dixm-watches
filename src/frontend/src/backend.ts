...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: string, arg4: string, arg5: boolean): Promise<void> {
    ...
    async addSeedDataAvantGarde(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSeedDataAvantGarde();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addSeedDataHeritage(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSeedDataHeritage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addSeedDataPrecision(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSeedDataPrecision();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllProducts(): Promise<Array<WatchProduct>> {
        if (this.processError) {
            try {
    ...
    async getProductById(arg0: bigint): Promise<WatchProduct> {
        if (this.processError) {
            try {
    ...
    async getProductsByCollection(arg0: string): Promise<Array<WatchProduct>> {
        if (this.processError) {
            try {
